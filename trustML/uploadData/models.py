...
class Data(models.Model):
    ...
    model_score = models.IntegerField(default = 0)
...
class evaluation_result(models.Model):
    ...
    accset = models.CharField(validators=[int_list_validator],max_length=10000)
    uncset = models.CharField(validators=[int_list_validator],max_length=10000)
    model_score = models.IntegerField(default = 0)
    data_score = models.IntegerField(default = 0)
    class Meta:
