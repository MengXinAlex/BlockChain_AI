    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('wallet_address', models.CharField(default='0x073c534B256486a385223f426b91617F66640E9A', max_length=42)),
                ('image', models.ImageField(blank=True, upload_to='user_photo/')),
                ('cover', models.ImageField(blank=True, upload_to='user_photo/')),
                ('description', models.CharField(default='Add a short description of yourself.', max_length=1000)),
